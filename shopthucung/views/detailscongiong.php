<!-- Hiển thị chi tiết sản phẩm -->
    <div class="body">
            <a class="buy_continute" href="index.php?page=congiong"><i class="fa fa-arrow-circle-left"></i> Trở lại mua hàng</a>
        ...
        <div class="row">
            ...
            ?>
                <div class="col-lg-2_5 col-md-4 col-6">
                    <a href="index.php?page=detailscongiong&id=<?php echo $valueRand['id_sanpham']; ?>" class="product">
